            ...
            <div style="width: 100%;overflow:hidden;margin-top:1rem;" >
           	<div   class="more_works" @click="goTo" v-if="is_dynamic">
				<div style="float: left;width: 0.75rem;height: 0.75rem;overflow: hidden;border-radius: 50%;margin-top: 0.125rem;position: relative;">
					<img :src="personal.opPic" style="position: absolute;top:50%; left:50%;transform: translate(-50%,-50%);" ref="tou" @load="tou_chuli"/><!--personal.opPic-->
				</div>
...
<!------------------------------------------------------------------------------------------------------------------->
			<div class="works_content">
				...
				<div style="width: 100%;overflow: hidden;">
					...
					<p style="display: inline-block;float: right;font-size:0.32rem;color: #FF9D00;line-height: 0.7rem;" v-if="works_data.retailPrice">.00</p>
					<p style="display: inline-block;float: right;font-size:0.42rem;color: #FF9D00;" v-if="works_data.retailPrice">￥{{works_data.retailPrice}}</p>
				</div>
				<p class="introduce_content">{{html_detail(works_data)}}</p>
				<div class="tip">
...
//		mixins:[wxapi],
	    ...
	    computed:{
	    	...
	    	create_Decade(){
return (this.works_data.artDecription==null)?"":'/'+this.works_data.artDecription.createDecade
	    	},
	    	material(){
return (this.works_data.artDecription==null)?"":'/'+this.works_data.artDecription.material	    		
	    	},
	    	create_Theme(){
return 	(this.works_data.artDecription==null)?"":'/'+this.works_data.artDecription.createTheme    		
	    	},
//	    	
	    	artHeight(){
return (this.works_data.artDecription==null||this.works_data.artDecription.artHeight==''||this.works_data.artDecription.artHeight==null)?"":'x'+this.works_data.artDecription.artHeight	    		
	    	},
	    		
	    	artLength(){
return (this.works_data.artDecription==null||this.works_data.artDecription.artLength=='')?"":'/'+this.works_data.artDecription.artLength	    		
	    	},
	    	artWidth(){
return (this.works_data.artDecription==null||this.works_data.artDecription.artWidth=='')?"":'x'+this.works_data.artDecription.artWidth	    		
	    	}
