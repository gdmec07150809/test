	...
	<div id="app">
		<div style="width: 100%;height: 1rem;position:fixed;top:0;left: 0;z-index: 9992;text-align:center;line-height: 0.88rem;border-bottom: 0.005rem solid #f1f1f1;background: white;">
			...
			<img style="width: 0.3rem;margin-right: 0.1rem;" src="../../assets/img/zuo.png" alt="" /></span>
	   		...
	   		<p style="font-size: 0.38rem;line-height: 1rem;float:left;margin-left: 2.9rem;">选择版块</p>
...
<script>
	...
	export default {
		...
		mounted(){
			this.ac_name = this.$store.state.diar_table 
			
			this.huoqu()
		},
		methods:{
			baocun(){//点击保存
				this.$store.state.diar_table = this.ac_name;
				this.$router.push({
								path: '../Diaries'
							});
			},
