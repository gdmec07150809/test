<template>
	...
	<div style="width: 100%;background:white;;z-index:300;" class="test">
		...
		<div v-for="(i,index) in pin"  style="width:95%;margin: 0 auto;position: relative;z-index: 300;overflow:hidden;">
			...
			<div style="width:100%;height:0.8rem;line-height:0.8rem;margin-top: 0.2rem;float: left;">
				<img class="tou" style="margin-top:0.1rem;" :src="i.disUserPic" alt="" />
				<p style="font-size:0.25rem;float:left;margin-left:0.2rem;color:#B1B1B1; color: #ff9d00;">{{i.disUser}}</p>
			...
			<div style="width: 6.47rem;margin-left:0.2rem;float:right;border-bottom:0.005rem solid #f1f1f1;">
				...
				<p style="font-size:0.28rem;margin-bottom: 0.24rem;word-break:break-all;white-space:normal;margin-left: 0.2rem;">
					{{i.disContent}}</p>
    			...
    			<!--<p style="font-size: 0.26rem;color: #F2850D;float: right;">打赏剪刀手</p>-->
    			</span>
